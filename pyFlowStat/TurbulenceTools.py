...
class TurbulenceTools(object):
	"""TurbulenceTools Class"""
	...
	def dofft(sig,samplefrq):
		...
		NFFT = TurbulenceTools.nextpow2(siglength)
	...
	@staticmethod
	def xcorr(x, y=None, maxlags=None, norm='ceoff'):
		'''
		...
		res = spsig.correlate(x, y, mode='full')
